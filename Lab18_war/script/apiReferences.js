...
function getReferences() {
    ...
    if (document.getElementById("filterDescription") == null)
        url = '/Lab18_war/References';
    else
        url = '/Lab18_war/References?filter='+ document.getElementById("filterDescription").value;
...
function deleteReference(id) {
    fetch('/Lab18_war/References?id='+id,{
        method : 'DELETE'
    }).then(()=>{
        getReferences();
    })
